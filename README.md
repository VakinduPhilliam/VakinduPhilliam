...
- 🌱 Akka (Scala/Java), Python/Django, PHP, Go (GoLang), Hadoop, Kotlin, Flutter/Dart, Cassandra, Play, Redis, Bull, Zookeeper, Kafka, Amazon DynamoDB, Serverless Framework, Elasticsearch, Apache Spark, AWS SAM, AWS Lambda, Numpy, Pandas, API Gateway, Git Version Control, MongoDB.
