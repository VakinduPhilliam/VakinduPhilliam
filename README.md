...
- 🌱 Akka (Scala/Java), Python/Django, PHP, Go (GoLang), Hadoop, Kotlin, Flutter/Dart, Cassandra, Play, Redis, Bull, Zookeeper, Kafka, AWS DynamoDB, Serverless Framework, Elasticsearch, Apache Spark, Git Version Control, MongoDB.
