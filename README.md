...
- 🌱 Akka (Scala/Java), Python/Django, PHP, Go (GoLang), Hadoop, Kotlin, Flutter/Dart, Cassandra, Play, Redis, Bull, Zookeeper, Kafka, Amazon DynamoDB, Serverless Framework, Elasticsearch, Apache Spark, AWS SAM, SBT, AWS Lambda, Google Cloud (GCP), Numpy, Pandas, API Gateway, Git Version Control, MongoDB, Docker, Docker-Compose, Giter8.
